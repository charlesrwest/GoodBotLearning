...
void DataLoader::ReadBlobs(char* inputBufferAddress, char* outputBufferAddress, int64_t numberOfBlobs)
{
for(int64_t blob_index = 0; blob_index < numberOfBlobs; blob_index++)
{
ReadBlob(inputBufferAddress + blob_index*InputBlobSize, outputBufferAddress + blob_index*OutputBlobSize);
}
}

void DataLoader::ReadBlob(char* inputBufferAddress, char* outputBufferAddress)
{
//Choose a buffer
...
void DataLoader::FillBuffer(int64_t bufferIndex)
{
